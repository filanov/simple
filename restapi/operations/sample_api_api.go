...
func NewSampleAPIAPI(spec *loads.Document) *SampleAPIAPI {
	return &SampleAPIAPI{
		...
		HelloGetHelloHandler: hello.GetHelloHandlerFunc(func(params hello.GetHelloParams) middleware.Responder {
			return middleware.NotImplemented("operation hello.GetHello has not yet been implemented")
		}),
	}
}
...
type SampleAPIAPI struct {
	...
	// HelloGetHelloHandler sets the operation handler for the get hello operation
	HelloGetHelloHandler hello.GetHelloHandler
...
func (o *SampleAPIAPI) Validate() error {
	...
	if o.HelloGetHelloHandler == nil {
		unregistered = append(unregistered, "hello.GetHelloHandler")
	}
...
func (o *SampleAPIAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/hello"] = hello.NewGetHello(o.context, o.HelloGetHelloHandler)
}
